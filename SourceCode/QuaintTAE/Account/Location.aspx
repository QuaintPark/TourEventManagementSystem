<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="Location.aspx.cs" Inherits="QuaintTAE.Account.Location" %>

<asp:Content ID="Content1" ContentPlaceHolderID="titleContentPlaceHolder" runat="server">
    <asp:Literal runat="server" Text="Location"></asp:Literal>
</asp:Content>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/LocationList.aspx" class="btn btn-default"><i class="fa fa-list-alt"></i>List</a>
                    </li>
                </ol>
            </section>
