<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QuaintTAE.Login" %>
...
<head runat="server">
    ...
    <title>
        <asp:Literal ID="defaultTitle" runat="server" Text="Smart Tour | Login"></asp:Literal>
    </title>
            ...
            <ContentTemplate>
                <div class="login-box">
                    <div class="login-logo">
                        <a runat="server" href="~/Default.aspx">Smart Tour</a>
                    </div>
                ...
                <asp:Timer ID="tmrAlertMessage" runat="server" Enabled="False"></asp:Timer>
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
